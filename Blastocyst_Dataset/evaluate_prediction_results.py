...
prediction_list = [r'C:\Users\kromp\OneDrive - Software Competence Center Hagenberg GmbH\Desktop\Projects\Blastozysten\Publication Nature Scientific Data\Revised_Dataset\For submission\prediction_xception.csv']
consensus_list = [r'C:\Users\kromp\OneDrive - Software Competence Center Hagenberg GmbH\Desktop\Projects\Blastozysten\Publication Nature Scientific Data\Revised_Dataset\For submission\Gardner_test_gold_onlyGardnerScores.csv']
acc_exp_list = []
acc_icm_list = []
acc_teq_list = []
annotator_list = []
